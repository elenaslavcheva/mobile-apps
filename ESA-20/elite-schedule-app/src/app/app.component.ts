...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen,public userSettings: UserSettingsProvider, public loadingController: LoadingController, public eliteApi: EliteApiProvider,public events: Events) {
    this.initializeApp();
